...
@Configuration
// - 이 클래스는 설정에 관련된 일을 하는 클래시임을 선언한다.
...
public class WebConfig implements WebMvcConfigurer {
  // - 이클래스는 WebMvcConfigurer 규치엑 따라 메서드를 만들었음을 선언한다.
  ...
  // Cross-Origin 관련해서 기본 값 외에 추가로 설정을 이 메서드를 정의한다.
  // 스프링부트가 시작된면 이 메서드를 호출하여 CrossOrigin을 설정할 것이다.
  @Override
